...
import { type Agent, AgentError, choice, sample } from '../src/ai/base';
import { now } from '../src/ai/clock';
import { DEFAULT_WEIGHTS, type Weights, evaluate } from '../src/ai/evaluate';
import { actionValue } from '../src/ai/greedyAgent';

/**
 * Evaluation units are roughly "points"; this squashes a plausible swing into
 * [-1, 1] without saturating on ordinary positions.
 */
const VALUE_SCALE = 25.0;
...
export class LegacyMctsAgent implements Agent {
