/**
 * Master level hybrid agent (formerly Expert Scheme A).
 *
...
export class MasterHybridAgent implements Agent {
  readonly level: AgentLevel = 'master';
  nodes = 0;
  reachedDepth = 0;
  cappedOut = false;
  ...
  choose(state: GameState, player: number): Action {
    ...
    // Form competitive candidate pool: moves within tolerance of optimal
